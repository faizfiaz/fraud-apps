...
import com.fraud.apps.data.local.PreferencesManager
import com.fraud.apps.data.local.dao.DaoFraud
import com.fraud.apps.data.local.dao.DaoReport
import com.fraud.apps.data.local.table.TableFraud
